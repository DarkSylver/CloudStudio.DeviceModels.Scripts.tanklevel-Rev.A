...
# Parsing + Configuration Script – tank_level - Rev. A

This **Parsing + Configuration** script is designed for the **tank_level** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – tank_level Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **tank_level** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
