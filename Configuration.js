...
function getEndpoints(deviceAddress, endpoints)
{
    ...
    var alarm = endpoints.addEndpoint("1", "Tank level", endpointType.genericSensor);
        alarm.variableTypeId = 1202;
    ...
    var bat = endpoints.addEndpoint("3", "Battery", endpointType.genericSensor);
        bat.variableTypeId = 1198;

    var gal = endpoints.addEndpoint("4", "Tank Level in Gallons", endpointType.genericSensor);
        gal.variableTypeId = 1223;
